          ...
          <div className="flex items-center gap-2">
            ...
            {connected ? (
              <div className="dropdown dropdown-hover">
                ...
                >
                  <li className="hover:bg-[rgba(219, 243, 136, 0.5)] rounded-box relative" onClick={onEditProfileStart}>
                    <img src="/profile-icon.png" width={55} height={55} className="absolute left-0 top-0" />
                    <a className="text-[#1D2F2F] text-[14px]" style={{ textIndent: '2.2em' }}>{`Edit Profile`}</a>
                  </li>
                  <div className="border border-[#1D2F2F]/50 w-[80%] mx-auto"></div>
                  <li className="hover:bg-[rgba(219, 243, 136, 0.5)] rounded-box relative" onClick={onLogout}>
                    <img src="/logout-icon.png" width={55} height={55} className="absolute left-0 top-0" />
                    <a className="text-[#1D2F2F] text-[14px]" style={{ textIndent: '2.5em' }}>
                      Disconnect
                    </a>
                  </li>
                </ul>
      ...
      <dialog id="new_buzz_modal" className="modal  !z-20">
        <div className="modal-box bg-[#191C20] !z-20 py-5 w-[50%]">
          <form method="dialog">
            ...
            <button className="border border-white text-white btn btn-xs btn-circle absolute right-5 top-5.5">✕</button>
          </form>
