      ...
      <div className="modal-box bg-[#191C20] py-5  w-[50%]">
        ...
        <div className="flex flex-col relative items-start">
          <div className="w-full  flex items-center justify-center pt-4">
            <BookCheck size={120} className="text-lime-500 bg-lime-800/20 rounded-full p-6 rotate-12" />
          </div>
          ...
          <p className="text-gray">BitBuzz charges a service fee of 1999 satoshi per PIN.</p>
          <p className="text-gray mt-2">
            We encourage more developers to run their own BitBuzz or create an improved version to compete with us.
          </p>
