...
const Home = () => {
  ...
  const stillPool = isNil(userInfo)
    ? false
    : checkMetaidInitStillPool(userInfo);
    ...
    <main className='relative'>
      ...
      {stillPool && (
        <div className='absolute text-[13px] top-[-20px] text-main'>
          <div>
            Your MetaID TX hasn't been confirmed yet. You can start using the
            platform once your MetaID TX is confirmed.
          </div>
          <div
